...
func (a *acrProvider) Provide(repoToPull string) credentialprovider.DockerConfig {
...
func (a *acrProvider) LazyProvide(repoToPull string) *credentialprovider.DockerConfigEntry {
	return nil
}
