...
func (g *dockerConfigKeyProvider) LazyProvide(repoToPull string) *credentialprovider.DockerConfigEntry {
	return nil
}

// Provide implements DockerConfigProvider
func (g *dockerConfigKeyProvider) Provide(repoToPull string) credentialprovider.DockerConfig {
...
// LazyProvide implements DockerConfigProvider. Should never be called.
func (g *dockerConfigUrlKeyProvider) LazyProvide(repoToPull string) *credentialprovider.DockerConfigEntry {
	return nil
}

// Provide implements DockerConfigProvider
func (g *dockerConfigUrlKeyProvider) Provide(repoToPull string) credentialprovider.DockerConfig {
...
// LazyProvide implements DockerConfigProvider. Should never be called.
func (g *containerRegistryProvider) LazyProvide(repoToPull string) *credentialprovider.DockerConfigEntry {
	return nil
}

// Provide implements DockerConfigProvider
func (g *containerRegistryProvider) Provide(repoToPull string) credentialprovider.DockerConfig {
